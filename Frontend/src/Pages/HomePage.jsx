...
function Homepage() {
  const iaAuthenticated = useSelector((state) => state?.auth?.isAuthenticated);
      ...
      <header className="bg-blue-600 text-white">
        <div className="container mx-auto p-4 flex justify-between items-center">
          ...
          {iaAuthenticated ? (
            ...
            <>
              <button className="bg-white text-blue-600 px-4 py-2 rounded hover:bg-blue-600 hover:text-white">
                Logout
              </button>
            </>
          )}
      ...
      <main className="flex-grow flex items-center justify-center bg-gray-100">
        <div className="text-center">
          ...
          <p className="text-lg mb-8">
            Collaborate on documents in real-time with your team. Create, edit,
